  ...
  return (
    <div className="min-h-screen flex flex-col">
      <main className="flex-grow">
              ...
              <div className="md:w-1/2 space-y-3">
                ...
                <div className="flex flex-wrap gap-3 pt-2">
                  ...
                  <SignedIn>
                    <Link 
                      href="/dashboard" 
                      className="btn-primary px-5 py-2 rounded-lg font-montserrat shadow-lg hover:shadow-xl transition text-white flex items-center gap-2"
                    >
        ...
        {/* Transactions Section - Only show for non-authenticated users */}
        <SignedOut>
        ...
        {/* Budgeting Section - Only show for non-authenticated users */}
        <SignedOut>
        ...
        {/* About Section - Only show for non-authenticated users */}
        <SignedOut>
