          ...
          <div className="flex justify-between items-center">
            ...
            <SignedIn>
              <div className="flex items-center gap-6">
                <Link href="/dashboard" className="text-foreground hover:text-primary transition-colors hidden md:flex items-center gap-2">
                ...
                <Link href="/dashboard/transactions" className="text-foreground hover:text-primary transition-colors hidden md:flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" />
                  </svg>
                  Transactions
                </Link>
                <Link href="/dashboard/budgeting" className="text-foreground hover:text-primary transition-colors hidden md:flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
