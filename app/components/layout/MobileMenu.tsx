...
export function MobileMenu() {
  ...
  return (
    <>
      ...
      {/* Mobile menu */}
      <div 
        className={`fixed right-0 top-0 h-full w-[280px] bg-background z-40 shadow-xl transform transition-transform duration-300 md:hidden ${
            ...
            <SignedIn>
              ...
              <div className="mt-4 flex items-center gap-4">
                <UserButton 
                  ...
                  appearance={{
                    elements: {
                      userButtonAvatarBox: "w-10 h-10 border-2 border-primary-light hover:border-primary transition-colors",
                      userButtonTrigger: "hover:opacity-80 transition-opacity"
                    }
                  }}
                />
                <span className="text-sm text-gray-dark">Manage Account</span>
              </div>
            </SignedIn>
          </nav>
